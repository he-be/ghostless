...
public class GhostlessReceiver : MonoBehaviour
{
    ...
    public string blinkShapeL = "Fcl_EYE_Close_L"; // Left Eye
    public string blinkShapeR = "Fcl_EYE_Close_R"; // Right Eye
    ...
    void ApplyFaceDirect()
    {
        ...
        // Drive BOTH Left and Right eyes with the same 'tBlink' value
